...
训练英文版傲慢与偏见：
![Local image](data/posts/img/44.png)
![Local image](data/posts/img/45.png)
测试结果：
![Local image](data/posts/img/46.png)
![Local image](data/posts/img/47.png)

### [BPEmb](www.bpemb.h-its.org)
给笔者的感觉是产品化的bpe，访问官网可能需要一点技术手段，这里贴上截图。可以看到目前为止已经支持了275种语言，并且我大中华汉语也赫然在列。
![Local image](data/posts/img/48.png)
附上官方用例，可能是训练集的原因，看效果比subword-nmt好：
![Local image](data/posts/img/49.png)
...
![Local image](data/posts/img/50.png)
![Local image](data/posts/img/51.png)
...
![Local image](data/posts/img/52.png)
...
![Local image](data/posts/img/53.png)
![Local image](data/posts/img/54.png)

### 结巴分词
专门针对汉语的分词器，非常好用。功能很多，包括但不限于分词、自定义词典、关键词提取、词性标注功能。
![Local image](data/posts/img/55.png)

### [Spacy](https://spacy.io/)
功能包括但不限于支持多国语言、分词、词性标注、词干化、命名实体识别、名词短语提取，不多说直接上干货
![Local image](data/posts/img/56.png)